...
function testRandomInRange() {
  ...
  console.log("\n测试用例 2: 范围 -5 到 5");
  for (let i = 0; i < 5; i++) {
    console.log(randomInRange(-5, 5));
  }

  console.log("\n测试用例 3: 相同的最小值和最大值");
  console.log(randomInRange(7, 7));

  console.log("\n测试用例 4: 最小值大于最大值");
  console.log(randomInRange(10, 1));

  console.log("\n测试用例 5: 小数范围");
  for (let i = 0; i < 5; i++) {
    console.log(randomInRange(1.5, 3.5));
  }

  console.log("\n测试用例 6: 大范围数字");
  console.log(randomInRange(1000000, 2000000));
